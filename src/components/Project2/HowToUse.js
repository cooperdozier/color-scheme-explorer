    ...
    render () {
        return (
            <div>
                ...
                <img src={require("../../images/random-palette-page-no-layout.png")} alt="" role="presentation" />
                <h2 className='home-h2'>Screenshot of 'Configure Colors' with Randomized Texts, H3's, P's</h2>
                <img src={require("../../images/configure-colors-page.png")} alt="" role="presentation" />
                <h2 className='home-h2'>Screenshot of 'Randomize Page'</h2>
                <img src={require("../../images/layout-page.png")} alt="" role="presentation" />
